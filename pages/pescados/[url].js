...
export default function PescadoURL({pescado}) {
...
export async function getServerSideProps({query: {url}}) {
  ...
  const respuesta = await fetch(`${process.env.API_URL}/pescados?filters[url]=${url}&populate=imagen`)
  const {data: pescado} = await respuesta.json()
