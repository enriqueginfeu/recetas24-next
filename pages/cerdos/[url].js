...
export default function CerdoURL({cerdo}) {
...
export async function getServerSideProps({query: {url}}) {
  ...
  const respuesta = await fetch(`${process.env.API_URL}/cerdos?filters[url]=${url}&populate=imagen`)
  const {data: cerdo} = await respuesta.json()
