...
export default function PolloURL({pollo}) {
...
export async function getServerSideProps({query: {url}}) {
  ...
  const respuesta = await fetch(`${process.env.API_URL}/pollos?filters[url]=${url}&populate=imagen`)
  const {data: pollo} = await respuesta.json()
