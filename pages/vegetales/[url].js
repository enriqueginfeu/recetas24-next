...
export default function VegetalURL({vegetal}) {
...
export async function getServerSideProps({query: {url}}) {
  ...
  const respuesta = await fetch(`${process.env.API_URL}/vegetales?filters[url]=${url}&populate=imagen`)
  const {data: vegetal} = await respuesta.json()
