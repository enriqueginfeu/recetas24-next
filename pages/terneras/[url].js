...
export default function TerneraURL({ternera}) {
...
export async function getServerSideProps({query: {url}}) {
  ...
  const respuesta = await fetch(`${process.env.API_URL}/terneras?filters[url]=${url}&populate=imagen`)
  const {data: ternera} = await respuesta.json()
